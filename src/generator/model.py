...
# Use https://netron.app/ to look at the model

def _Peephole_LSTM_RNN(units, lb, feature_size, la, ra, wi, ri, bi, oa):
    ...
    lstm_layer1 = keras.layers.RNN(keras.experimental.PeepholeLSTMCell(units, 
                                activation = la,
                                recurrent_activation = ra,
                                #kernel_initializer = wi,
                                recurrent_initializer = ri,
                                bias_initializer = bi), return_sequences=True)(input_layer)
    lstm_layer2 = keras.layers.RNN(keras.experimental.PeepholeLSTMCell(units, 
                                activation = la,
                                recurrent_activation = ra,
                                #kernel_initializer = wi,
                                recurrent_initializer = ri,
                                bias_initializer = bi), return_sequences=True)(lstm_layer1)
    lstm_layer3 = keras.layers.RNN(keras.experimental.PeepholeLSTMCell(units, 
                                activation = la,
                                recurrent_activation = ra,
                                #kernel_initializer = wi,
                                recurrent_initializer = ri,
                                bias_initializer = bi), return_sequences=True)(lstm_layer2)
